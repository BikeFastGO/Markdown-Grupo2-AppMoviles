...
|-----------|-----------|-----------|
<<<<<<< Updated upstream
| Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.| **Giakomo Causso Rodolfo Mariano:** <br> **- TB1/TB2/TP1/TB3/TF:** Realicé una investigación exhaustiva de literatura científica en bases como SCImago Journal Rank para fundamentar nuestro proyecto de alquiler de bicicletas con datos actuales y relevantes. Seleccioné y analicé artículos especializados, integrando citas y referencias dentro del proceso Lean UX para enriquecer el contenido con evidencia científica. Este enfoque no solo refuerza la validez de nuestra propuesta, sino que también demuestra la aplicación práctica de conocimientos teóricos en un contexto real de desarrollo de software, actualizando mis competencias y contribuyendo significativamente al proyecto. <br> **Manuel Alexis Vargas Quispe:** <br> **- TB1/TB2/TP/TB3:** Se implementó el lean UX Canvas, así como ayudar en parte del Cap2 - Realizó de manera satisfactoria los flow diagrams y user stories/product backlog - También se realizó una primer avance del front de nuestro trabajo y también el completar toda la documentación. <br>**- TB4:** Sprint 3 - Videos <br> **- TF:** Investigación exhaustiva de literatura científica para fundamentar un proyecto de alquiler de bicicletas, integrando datos actuales en un proceso Lean UX y aplicando conocimientos teóricos en desarrollo de software. <<br>**Max Sabino Arostegui:** <br> **- TB1/TB2/TP/TB3:** Se realizó el estudio comparativo con respecto a nuestros competidores, se planteo estrategias y tacticas. Asimismo, se realizó el analisis de las entrevistas. <br>**- TB4:** Sprint 3 - Videos <br> **- Alejandro Angel Nolasco Morales:** <br> **TB1/TB2/TP/TB3:** Se realizaron las "hypothesis" en base a las necesidades y problemáticas del proyecto, se realizaron wireframes, mockup, lógica y landing page. <br>**- TB4:** Sprint 3 - Videos <br> |Los objetivos establecidos se alcanzaron mediante una comunicación constante y una organización eficaz por parte de nuestro equipo, lo que facilitó la elaboración y la implementación exitosa de la primera entregrea del proyecto. |
| Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.  | **Giakomo Causso Rodolfo Mariano:** <br> **- TB1/TB2/TP1/TB3/TF:** He reconocido la importancia del aprendizaje continuo en el campo del desarrollo de software al integrar investigaciones actuales y métodos basados en evidencia en nuestro proyecto de alquiler de bicicletas. Esto implicó la búsqueda activa de fuentes académicas relevantes y su aplicación directa para fortalecer nuestro enfoque de Lean UX, asegurando que el proyecto no solo cumpla con los estándares contemporáneos de tecnología y sostenibilidad, sino que también refleje prácticas innovadoras en soluciones de software. Esta acción subraya mi compromiso con el desarrollo profesional continuo y la mejora de las habilidades necesarias para afrontar y resolver desafíos en el ámbito profesional y tecnológico.**Max Sabino Arostegui:** <br> **- TB1/TB2/TP1/TB3:** Se investigó a los competidore y evaluo el FODA de cada uno, asimismo se diseño las preguntas para realizar las entrevistas a nuestros dos segmentos objetivos.<br>**- TB4:** Sprint 3 - Videos <br> **Manuel Alexis Vargas Quispe:** <br> **- TB1/TB2/TP1/TB3:** Elaboracion del Sprint 2 reforzando, mejorando y añadiendo los puntos anteriores para que la aplicacion sea completo junto a las mejoras del doc. <br>**- TB4:** Sprint 3 - Videos <br> **- TF:** Integración de métodos basados en evidencia y prácticas innovadoras en un proyecto de alquiler de bicicletas, resaltando el compromiso con el desarrollo profesional continuo y la mejora en el ámbito tecnológico. <br>**Alejandro Angel Nolasco Morales:** <br> **- TB1/TB2/TP1/TB3:** Se realizó el acercamiento visual con interacción, siguiendo las HU y goals para fidelidad de BikeFastGo, se utilizaron herramientas de elaboración de wireframes, landing page con css js y html. <br>**- TB4:** Sprint 3 - Videos <br>| Se alcanzó con éxito el objetivo de elaborar y retroalimentar tanto el informe técnico como el funcional. Además, se llevó a cabo de manera correcta y exitosa los puntos del Capitulo I y II |
=======
| Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.| **Giakomo Causso Rodolfo Mariano:** <br> **- TB1/TB2/TP1/TB3/TB4/TF:** Realicé una investigación exhaustiva de literatura científica en bases como SCImago Journal Rank para fundamentar nuestro proyecto de alquiler de bicicletas con datos actuales y relevantes. Seleccioné y analicé artículos especializados, integrando citas y referencias dentro del proceso Lean UX para enriquecer el contenido con evidencia científica. Este enfoque no solo refuerza la validez de nuestra propuesta, sino que también demuestra la aplicación práctica de conocimientos teóricos en un contexto real de desarrollo de software, actualizando mis competencias y contribuyendo significativamente al proyecto. <br> **Manuel Alexis Vargas Quispe:** <br> **- TB1/TB2/TP/TB3:** Se implementó el lean UX Canvas, así como ayudar en parte del Cap2 - Realizó de manera satisfactoria los flow diagrams y user stories/product backlog - También se realizó una primer avance del front de nuestro trabajo y también el completar toda la documentación. <br>**- TB4:** Sprint 3 - Videos <br> **Max Sabino Arostegui:** <br> **- TB1/TB2/TP/TB3/TB4/TF:** Usé investigaciones actuales para fundamentar nuestro proyecto. <br> **- Alejandro Angel Nolasco Morales:** <br> **TB1/TB2/TP/TB3:** Se realizaron las "hypothesis" en base a las necesidades y problemáticas del proyecto, se realizaron wireframes, mockup, lógica y landing page. <br>**- TB4:** Sprint 3 - Videos <br> |Los objetivos establecidos se alcanzaron mediante una comunicación constante y una organización eficaz por parte de nuestro equipo, lo que facilitó la elaboración y la implementación exitosa de la primera entregrea del proyecto. |
| Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.  | **Giakomo Causso Rodolfo Mariano:** <br> **- TB1/TB2/TP1/TB3/TB4/TF:** He reconocido la importancia del aprendizaje continuo en el campo del desarrollo de software al integrar investigaciones actuales y métodos basados en evidencia en nuestro proyecto de alquiler de bicicletas. Esto implicó la búsqueda activa de fuentes académicas relevantes y su aplicación directa para fortalecer nuestro enfoque de Lean UX, asegurando que el proyecto no solo cumpla con los estándares contemporáneos de tecnología y sostenibilidad, sino que también refleje prácticas innovadoras en soluciones de software. Esta acción subraya mi compromiso con el desarrollo profesional continuo y la mejora de las habilidades necesarias para afrontar y resolver desafíos en el ámbito profesional y tecnológico.**Max Sabino Arostegui:** <br> **- TB1/TB2/TP1/TB3/TB4/TF:** Apliqué estudios recientes para demostrar la importancia del aprendizaje constante en el desarrollo de software. <br> **Manuel Alexis Vargas Quispe:** <br> **- TB1/TB2/TP1/TB3:** Elaboracion del Sprint 2 reforzando, mejorando y añadiendo los puntos anteriores para que la aplicacion sea completo junto a las mejoras del doc. <br>**- TB4:** Sprint 3 - Videos <br>**Alejandro Angel Nolasco Morales:** <br> **- TB1/TB2/TP1/TB3:** Se realizó el acercamiento visual con interacción, siguiendo las HU y goals para fidelidad de BikeFastGo, se utilizaron herramientas de elaboración de wireframes, landing page con css js y html. <br>**- TB4:** Sprint 3 - Videos <br>| Se alcanzó con éxito el objetivo de elaborar y retroalimentar tanto el informe técnico como el funcional. Además, se llevó a cabo de manera correcta y exitosa los puntos del Capitulo I y II |
>>>>>>> Stashed changes
...
<tr><td colspan="1" rowspan="3" valign="top"><p><b>P</b></p><p><b>R</b></p><p><b>F</b></p><p><b>I</b></p><p><b>L</b></p><p></p><p><b>D</b></p><p><b>E</b></p><p></p><p><b>P</b></p><p><b>R</b></p><p><b>O</b></p><p><b>D</b></p><p><b>U</b></p><p><b>C</b></p><p><b>T</b></p><p><b>O</b></p></td><td colspan="1" valign="top"><p>Productos &  </p><p>Servicios</p></td><td colspan="1" valign="top"><p>Servicio de alquiler de una gran de variedad de bicicletas</p><p></p></td><td colspan="1" valign="top"><p>Servicio de alquiler de bicicletas para uso cotidiano</p><p></p><p></p></td><td colspan="1" valign="top"><p>Servicio de alquiler de bicicletas para proyectos cortos o largos.</p><p></p></td><td colspan="1" valign="top"><p>Servicio de alquiler temporal de bicicletas</p><p></p></td></tr>
<tr><td colspan="1" valign="top">Precios y Costos</td><td colspan="1" valign="top">Buscamos contar con precios S/. 5 a más para las bicicletas</td><td colspan="1" valign="top"><p>Planes desde los $15 hasta los $100</p><p></p></td><td colspan="1" valign="top"><p>Tarifas disponibles desde €10 hasta €40.</p><p></p><p></p></td><td colspan="1" valign="top"><p>Pases desde S/ 4.33 hasta S/151.73.</p><p></p><p></p></td></tr>
<tr><td colspan="1" valign="top"><p>Canales de  </p><p>distribución  </p><p>(Web y/o Móvil)</p></td><td colspan="1" valign="top"><p>Landing page, facebook, Instagram, tiktok</p><p></p></td><td colspan="1" valign="top">App oficial y redes sociales</td><td colspan="1" valign="top">Sitio web, redes sociales</td><td colspan="1" valign="top">Página web y redes sociales</td></tr>
<tr><td colspan="1" rowspan="4" valign="top"><p><b>A</b></p><p><b>N</b></p><p><b>Á</b></p><p><b>L</b></p><p><b>I</b></p><p><b>S</b></p><p><b>I</b></p><p><b>S</b></p><p></p><p><b>S</b></p><p><b>W</b></p><p><b>O</b></p><p><b>T</b></p></td><td colspan="5" valign="top">Realice esto para su startup y sus competidores. Sus fortalezas deberían apoyar sus oportunidades y contribuir a lo que ustedes definen como su posible ventaja competitiva. </td></tr>
<tr><td colspan="1" valign="top">Fortalezas</td><td colspan="1" valign="top"><p>Contar con variedad en el tipo de bicicletas, planes o tarifas desde el alcance de todos.</p><p></p></td><td colspan="1" valign="top">Cuenta con seguridad gracias a su sistema GPS</td><td colspan="1" valign="top">Cuentas con puntos disponibles en varias zonas, ampliando su disponibilidad</td><td colspan="1" valign="top"><p>Cuenta con más de 500 bicicletas disponibles en distintos puntos de miraflores</p><p></p></td></tr>
<tr><td colspan="1" valign="top">Debilidades</td><td colspan="1" valign="top">Ser un aplicativo nuevo sin ninguna referencia o valoración.</td><td colspan="1" valign="top"><p>Falta de bicicletas para un mayor número de usuarios</p><p></p></td><td colspan="1" valign="top">Solo tiene un tipo de bicicletas (básica) para todo el publico</td><td colspan="1" valign="top">Se limita solo para el distrito de miraflores.</td></tr>
